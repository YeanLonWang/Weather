...
[![Build Status](https://travis-ci.org/wangyanlong/weather.svg?branch=master)](https://travis-ci.org/wangyanlong/weather) 
...
可以用两种方式来获取 `Wangyanlong\Weather\Weather` 实例：
